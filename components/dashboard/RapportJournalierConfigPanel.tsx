...
const ITEMS: { field: keyof RapportJournalierConfigPayload; label: string; hint?: string }[] = [
  ...
  { field: "show_tranche_age",           label: "Répartition par tranche d'âge",    hint: "Calculée à partir des dégustations saisies par les hôtesses" },
  { field: "show_notes_degustation",     label: "Notes moyennes de goût et d'ambiance", hint: "Si activées sur la campagne" },
  ...
  const handleSave = async () => {
    ...
    try {
      const payload: RapportJournalierConfigPayload = {
        ...
        show_tranche_age: config.show_tranche_age,
        show_notes_degustation: config.show_notes_degustation,
